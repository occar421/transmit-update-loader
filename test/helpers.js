 ...
 */
export const readFileAsync = (fileName) => promisify(fs.readFile)(path.join(__dirname, fileName)).then(b => b.toString());

/**
 * @param {string} fileName
 * @returns {Promise<"fs".Stats>}
 */
export const fileStatAsync = (fileName) => promisify(fs.stat)(path.join(__dirname, fileName));
